...
async def get_crypto_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    ath = humanize.intword(crypto_data['market_data']['ath']["usd"])
    ...
    atl = humanize.intword(crypto_data['market_data']['atl']["usd"])
    ...
    message = f"{market_cap_rank}° {crypto_name} ({crypto_symbol})\n" \
...
if __name__ == '__main__':
    ...
    crypto_price_handler = CommandHandler('p', get_crypto_price)
